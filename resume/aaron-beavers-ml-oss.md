...
- Built a generative Clojure DSL + multi-stage pipeline to produce publication-grade adversarial prompt evaluation datasets with full provenance.
...
- Authored the ML design/research direction: parser ensemble first, dense embeddings + hybrid fusion next, with explicit guardrails against employer-side candidate ranking.
