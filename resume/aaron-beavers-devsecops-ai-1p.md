---
title: "Aaron Beavers — Resume (DevSecOps + AI Systems, 1 Page)"
---
...
- **Security & reliability**: OAuth PKCE, token-gated APIs, provider-scoped key/OAuth account rotation on rate limits, retries/timeouts/backoff, secure file handling, audit-friendly logging
