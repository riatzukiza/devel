...
import { mcpMuxRoutes } from "./routes/mcp-mux.js";
...
export async function createApp(cfg: GatewayConfig): Promise<FastifyInstance> {
  ...
  await app.register(mcpMuxRoutes, {
    prefix: "/api",
    mcpServiceUrls: cfg.mcpServiceUrls ?? {},
    mcpInternalSharedSecret: cfg.mcpInternalSharedSecret,
  });
