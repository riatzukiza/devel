...
export function computeAttachmentSig(attachments: DiscordAttachment[]): AttachmentSignature {
  ...
  const imageAttachments: DiscordAttachment[] = [];
  ...
  for (const att of attachments) {
    if (att.contentType) {
      ...
      // Log image attachments with full details
  ...
  // Log summary of all images found
