          ...
          narrativeBranches: [
            {
              ...
              realism: 65, fear: 70, publicBenefit: 20, actionability: 30,
              polarizationRisk: 45, compressionLoss: 35,
            },
            {
              label: "economic adaptation",
              probability: 0.45,
              evidence: ["Market diversification", "Alternative routes"],
              realism: 75, fear: 30, publicBenefit: 60, actionability: 55,
              polarizationRisk: 20, compressionLoss: 25,
            },
          ],
          compressionLoss: 0.4,
        },
