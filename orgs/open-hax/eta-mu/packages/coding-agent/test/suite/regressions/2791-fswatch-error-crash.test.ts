...
/**
 * Regression test for https://github.com/open-hax/eta-mu/issues/2791
 *
...
process.env.ETA_MU_CODING_AGENT_DIR = "${agentDir}";
...
`,
		...
		try {
			_stdout = execFileSync("npx", ["tsx", scriptPath], {
				timeout: 10000,
				encoding: "utf-8",
				env: { ...process.env, ETA_MU_CODING_AGENT_DIR: agentDir },
