...
import type { AssistantMessage, Model } from "@open-hax/eta-mu-ai";
...
vi.mock("@open-hax/eta-mu-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@open-hax/eta-mu-ai")>();
	return {
		...actual,
