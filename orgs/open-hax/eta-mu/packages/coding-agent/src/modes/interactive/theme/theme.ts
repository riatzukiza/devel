...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@open-hax/eta-mu-tui";
...
const THEME_KEY = Symbol.for("@open-hax/eta-mu-cli:theme");
...
export function getSettingsListTheme(): import("@open-hax/eta-mu-tui").SettingsListTheme {
	return {
