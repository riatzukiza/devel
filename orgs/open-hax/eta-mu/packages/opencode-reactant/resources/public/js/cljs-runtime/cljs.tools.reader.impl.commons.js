...
var G__12586 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__12586;
continue;
} else {
return ch;
...
var vec__12574 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12574,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq12581){
...
return (function() { 
var G__12595__delegate = function (rdr,_){
...
var G__12595 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__12596__i = 0, G__12596__a = new Array(arguments.length -  1);
while (G__12596__i < G__12596__a.length) {G__12596__a[G__12596__i] = arguments[G__12596__i + 1]; ++G__12596__i;}
  _ = new cljs.core.IndexedSeq(G__12596__a,0,null);
} 
return G__12595__delegate.call(this,rdr,_);};
G__12595.cljs$lang$maxFixedArity = 1;
G__12595.cljs$lang$applyTo = (function (arglist__12597){
var rdr = cljs.core.first(arglist__12597);
var _ = cljs.core.rest(arglist__12597);
return G__12595__delegate(rdr,_);
});
