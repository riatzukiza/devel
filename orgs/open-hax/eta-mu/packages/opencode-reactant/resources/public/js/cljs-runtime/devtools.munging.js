...
var o12447 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12447["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12448 = temp__5802__auto____$1;
return (o12448["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12070__auto__ = f;
return (o__12070__auto__["toString"]).call(o__12070__auto__);
} else {
return "";
}
}catch (e12464){var _ = e12464;
return "";
}});
...
try{var o__12070__auto___13345 = t;
(o__12070__auto___13345["cljs$lang$ctorPrWriter"]).call(o__12070__auto___13345,t,writer);
}catch (e12499){var __13346 = e12499;
}
...
var char_code = (function (){var o__12070__auto__ = (new String(char$));
return (o__12070__auto__["charCodeAt"]).call(o__12070__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12070__auto__ = String;
return (o__12070__auto__["fromCharCode"]).call(o__12070__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12556 = num_code;
switch (G__12556) {
case (1):
return (185);
...
var o__12070__auto__ = String;
return (o__12070__auto__["fromCharCode"]).call(o__12070__auto__,superscript_code);
});
/**
...
}catch (e12618){var _e__12108__auto__ = e12618;
return false;
}})())){
...
var vec__12622 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(0),null);
...
args__5732__auto__.push((arguments[i__5727__auto___13390]));

var G__13394 = (i__5727__auto___13390 + (1));
i__5727__auto___13390 = G__13394;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12737){
var vec__12739 = p__12737;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12739,(0),null);
...
var G__13398 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__13399 = cljs.core.butlast(remaining_tokens);
name_tokens = G__13398;
remaining_tokens = G__13399;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12713){
...
var vec__12772 = cljs.core.split_with((function (p1__12768_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12768_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12772,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12772,(1),null);
...
var vec__12800 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12800,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12800,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__13405 = cljs.core.rest(remaining_tokens);
var G__13406 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__13405;
name_tokens = G__13406;
continue;
} else {
...
var vec__12829 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12829,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12829,(1),null);
var vec__12832 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12832,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12832,(1),null);
var vec__12835 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12835,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12835,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12835,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12835,(3),null);
...
var vec__12883 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12883,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12883,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12883,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12883,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12883,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12883,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12899 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12899,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12899,(1),null);
var vec__12902 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12902,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12902,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12927 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12927) : devtools.munging.parse_fn_info_deep.call(null,G__12927));
})()));
}
} else {
return fn_info;
...
var G__13441 = (arity + (1));
var G__13442 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13001){
var vec__13002 = p__13001;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13002,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13002,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13051_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__13051_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13052_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__13052_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___13492 = arguments.length;
var i__5727__auto___13493 = (0);
while(true){
if((i__5727__auto___13493 < len__5726__auto___13492)){
args__5732__auto__.push((arguments[i__5727__auto___13493]));

var G__13502 = (i__5727__auto___13493 + (1));
i__5727__auto___13493 = G__13502;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13069){
var vec__13070 = p__13069;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13070,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13062){
var G__13063 = cljs.core.first(seq13062);
var seq13062__$1 = cljs.core.next(seq13062);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13063,seq13062__$1);
}));
...
var map__13123 = options;
var map__13123__$1 = cljs.core.__destructure_map(map__13123);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13123__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13123__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13123__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13123__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13124 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13124,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13124,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13124,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13124,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13124,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13124,(5),null);
...
var o__12070__auto__ = f;
return (o__12070__auto__["getBasis"]).call(o__12070__auto__);
});
/**
...
}catch (e13152){var _e__12108__auto__ = e13152;
...
var G__13624 = (obj[cljs.core.first(path)]);
var G__13625 = cljs.core.rest(path);
obj = G__13624;
path = G__13625;
continue;
} else {
...
var _STAR_ = (function (accum,p__13243){
var vec__13246 = p__13243;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13246,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13246,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13271){
var vec__13273 = p__13271;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13273,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13273,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13273,(2),null);
...
var post_process = (function (p__13327){
var vec__13328 = p__13327;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13328,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13328,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13297_SHARP_){
return (obj[cljs.core.first(p1__13297_SHARP_)]);
}),sorted_matches);
