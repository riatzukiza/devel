...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16115){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16116,G__16117,seq16115__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16196_SHARP_){
return (!((cljs.core.meta(p1__16196_SHARP_) == null)));
})))){
...
var map__16231 = opts;
var map__16231__$1 = cljs.core.__destructure_map(map__16231);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16231__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16238){var _e__12108__auto__ = e16238;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e16253){var _e__12108__auto__ = e16253;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__16269 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__16270 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__16270);
...
var map__16271 = opts;
var map__16271__$1 = cljs.core.__destructure_map(map__16271);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16271__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__16269);
}});
...
var temp__5802__auto___16377 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___16377)){
var managed_print_level_16384 = temp__5802__auto___16377;
var _STAR_print_level_STAR__orig_val__16275_16385 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16276_16386 = managed_print_level_16384;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16276_16386);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__16272_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__16272_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16275_16385);
}} else {
job_fn();
}
