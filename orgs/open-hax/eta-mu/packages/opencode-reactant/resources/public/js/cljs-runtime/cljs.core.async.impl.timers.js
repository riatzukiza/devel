...
var i_16777 = (0);
while(true){
if((i_16777 < arr.length)){
(arr[i_16777] = null);

var G__16782 = (i_16777 + (1));
i_16777 = G__16782;
continue;
} else {
}
...
var i_16802 = (self__.level + (1));
while(true){
if((i_16802 <= (new_level + (1)))){
(update[i_16802] = self__.header);

var G__16806 = (i_16802 + (1));
i_16802 = G__16806;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_16808 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16808[i]));
} else {
x__$2.forward.push((((i < links_16808.length))?(links_16808[i]):null));
}

if((i < links_16808.length)){
(links_16808[i] = x__$2);
} else {
links_16808.push(x__$2);
}
...
var i_16810 = (0);
while(true){
if((i_16810 <= self__.level)){
var links_16811 = (update[i_16810]).forward;
if((x__$1 === (((i_16810 < links_16811.length))?(links_16811[i_16810]):null))){
(links_16811[i_16810] = (x__$1.forward[i_16810]));

var G__16813 = (i_16810 + (1));
i_16810 = G__16813;
continue;
} else {
var G__16814 = (i_16810 + (1));
i_16810 = G__16814;
continue;
}
} else {
...
var G__16825 = nx;
var G__16826 = (level__$1 - (1));
x = G__16825;
level__$1 = G__16826;
continue;
} else {
var G__16827 = x;
var G__16828 = (level__$1 - (1));
x = G__16827;
level__$1 = G__16828;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__16833 = nx;
var G__16834 = (level__$1 - (1));
x = G__16833;
level__$1 = G__16834;
continue;
} else {
var G__16835 = x;
var G__16836 = (level__$1 - (1));
x = G__16835;
level__$1 = G__16836;
continue;
}
