...
var G__13420 = devtools.prefs.pref(v);
v = G__13420;
continue;
} else {
return v;
...
}catch (e13368){var _e__12108__auto__ = e13368;
return false;
}})();
...
}catch (e13374){var _e__12108__auto__ = e13374;
return false;
}})();
...
}catch (e13377){var _e__12108__auto__ = e13377;
return false;
}}
}
});
...
var vec__13391 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13391,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13391,(1),null);
...
return cljs.core.some((function (p1__13400_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13400_SHARP_);
}),template);
});
