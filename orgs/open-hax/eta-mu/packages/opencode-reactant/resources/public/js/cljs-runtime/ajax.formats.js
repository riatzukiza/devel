...
var G__22945 = request;
var G__22946 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__22945,G__22946) : ajax.formats.get_format.call(null,G__22945,G__22946));
} else {
...
return cljs.core.some((function (p1__22962_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__22962_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__22968){
var map__22969 = p__22968;
var map__22969__$1 = cljs.core.__destructure_map(map__22969);
var request = map__22969__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22969__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__22975 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__22975.cljs$core$IFn$_invoke$arity$1 ? fexpr__22975.cljs$core$IFn$_invoke$arity$1(response) : fexpr__22975.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__22977){
var map__22978 = p__22977;
var map__22978__$1 = cljs.core.__destructure_map(map__22978);
var request = map__22978__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22978__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__22976_SHARP_){
return ajax.formats.get_accept_entries(request,p1__22976_SHARP_);
