...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_13385 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_13385(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_13396 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_13396(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_13402 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_13402(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_13404 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_13404(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_13409 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_13409(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_13411 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_13411(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_13414 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_13414(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_13418 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_13418(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_13419 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_13419(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_13421 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_13421(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_13428 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_13428(b);
}
});
