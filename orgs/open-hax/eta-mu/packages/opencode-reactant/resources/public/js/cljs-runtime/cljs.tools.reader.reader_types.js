...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12515 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12515(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12516 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12516(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12517 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12517(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12518 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12518(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12519 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12519(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12520 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12520(reader);
}
});
...
var G__12529 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12530 = s.append(c);
c = G__12529;
s = G__12530;
continue;
}
