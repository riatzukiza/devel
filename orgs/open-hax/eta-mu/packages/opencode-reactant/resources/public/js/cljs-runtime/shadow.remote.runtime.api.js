...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16313 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16313(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_16324 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_16324(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_16335 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_16335(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_16339 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_16339(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16353 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16353(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16362 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16362(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__16295,callback){
var map__16296 = p__16295;
var map__16296__$1 = cljs.core.__destructure_map(map__16296);
var input = map__16296__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16296__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16296__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
