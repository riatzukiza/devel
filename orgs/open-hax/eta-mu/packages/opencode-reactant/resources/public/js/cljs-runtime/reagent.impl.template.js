...
var G__23214 = o;
reagent.impl.template.goog$module$goog$object.set(G__23214,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23279__delegate = function (args){
...
while (G__23280__i < G__23280__a.length) {G__23280__a[G__23280__i] = arguments[G__23280__i + 0]; ++G__23280__i;}
  args = new cljs.core.IndexedSeq(G__23280__a,0,null);
} 
return G__23279__delegate.call(this,args);};
G__23279.cljs$lang$maxFixedArity = 0;
G__23279.cljs$lang$applyTo = (function (arglist__23281){
var args = cljs.core.seq(arglist__23281);
return G__23279__delegate(args);
});
...
var G__23245 = o;
reagent.impl.template.goog$module$goog$object.set(G__23245,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23283__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__23284__i < G__23284__a.length) {G__23284__a[G__23284__i] = arguments[G__23284__i + 0]; ++G__23284__i;}
  args = new cljs.core.IndexedSeq(G__23284__a,0,null);
} 
return G__23283__delegate.call(this,args);};
G__23283.cljs$lang$maxFixedArity = 0;
G__23283.cljs$lang$applyTo = (function (arglist__23285){
var args = cljs.core.seq(arglist__23285);
return G__23283__delegate(args);
});
...
var G__23249 = props;
var G__23249__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23249,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23249);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23249__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23250 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23250,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23250;
}
})(),id_class);
...
var G__23251 = (cljs.core.count(argv) - first_child);
switch (G__23251) {
case (0):
...
var vec__23253 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23253,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23253,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23253,(2),null);
...
var temp__5808__auto___23288 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23288 == null)){
} else {
var key_23289 = temp__5808__auto___23288;
(jsprops.key = key_23289);
}
...
var temp__5808__auto___23290 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23290 == null)){
} else {
var key_23291 = temp__5808__auto___23290;
(jsprops.key = key_23291);
}
...
var temp__5808__auto___23292 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23292 == null)){
} else {
var key_23293 = temp__5808__auto___23292;
(jsprops.key = key_23293);
}
...
var temp__5808__auto___23296 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23296 == null)){
} else {
var key_23298 = temp__5808__auto___23296;
(jsprops.key = key_23298);
}
...
var temp__5808__auto___23300 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23300 == null)){
} else {
var key_23301 = temp__5808__auto___23300;
(jsprops.key = key_23301);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23261_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23261_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23262 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23262,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23262,(1),null);
...
break;
default:
var G__23309 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23310 = compiler;
v = G__23309;
compiler = G__23310;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template23272 = (function (opts,id,fn_to_element,parse_fn,meta23273){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23272.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23274,meta23273__$1){
var self__ = this;
var _23274__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23272(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23273__$1));
}));

(reagent.impl.template.t_reagent$impl$template23272.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23274){
var self__ = this;
var _23274__$1 = this;
return self__.meta23273;
}));

(reagent.impl.template.t_reagent$impl$template23272.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23272.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23272.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23272.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23272.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23272.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23273","meta23273",-97158658,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23272.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23272.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23272");

(reagent.impl.template.t_reagent$impl$template23272.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template23272");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23272.
 */
reagent.impl.template.__GT_t_reagent$impl$template23272 = (function reagent$impl$template$__GT_t_reagent$impl$template23272(opts,id,fn_to_element,parse_fn,meta23273){
return (new reagent.impl.template.t_reagent$impl$template23272(opts,id,fn_to_element,parse_fn,meta23273));
});
...
return (new reagent.impl.template.t_reagent$impl$template23272(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
