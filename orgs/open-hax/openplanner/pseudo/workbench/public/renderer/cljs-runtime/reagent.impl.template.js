...
var G__250568 = o;
reagent.impl.template.goog$module$goog$object.set(G__250568,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__250659__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__250659 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__250660__i = 0, G__250660__a = new Array(arguments.length -  0);
while (G__250660__i < G__250660__a.length) {G__250660__a[G__250660__i] = arguments[G__250660__i + 0]; ++G__250660__i;}
  args = new cljs.core.IndexedSeq(G__250660__a,0,null);
} 
return G__250659__delegate.call(this,args);};
G__250659.cljs$lang$maxFixedArity = 0;
G__250659.cljs$lang$applyTo = (function (arglist__250662){
var args = cljs.core.seq(arglist__250662);
return G__250659__delegate(args);
});
G__250659.cljs$core$IFn$_invoke$arity$variadic = G__250659__delegate;
return G__250659;
})()
;
} else {
...
var G__250578 = o;
reagent.impl.template.goog$module$goog$object.set(G__250578,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__250666__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__250666 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__250667__i = 0, G__250667__a = new Array(arguments.length -  0);
while (G__250667__i < G__250667__a.length) {G__250667__a[G__250667__i] = arguments[G__250667__i + 0]; ++G__250667__i;}
  args = new cljs.core.IndexedSeq(G__250667__a,0,null);
} 
return G__250666__delegate.call(this,args);};
G__250666.cljs$lang$maxFixedArity = 0;
G__250666.cljs$lang$applyTo = (function (arglist__250668){
var args = cljs.core.seq(arglist__250668);
return G__250666__delegate(args);
});
G__250666.cljs$core$IFn$_invoke$arity$variadic = G__250666__delegate;
return G__250666;
})()
;
} else {
...
var G__250587 = props;
var G__250587__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__250587,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__250587);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__250587__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
return G__250587__$1;
}
});
reagent.impl.template.convert_props = (function reagent$impl$template$convert_props(props,id_class){
var class$ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
var props__$1 = reagent.impl.template.set_id_class((function (){var G__250594 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__250594,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__250594;
}
})(),id_class);
...
var G__250597 = (cljs.core.count(argv) - first_child);
switch (G__250597) {
case (0):
...
var vec__250605 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__250605,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__250605,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__250605,(2),null);
...
var temp__5808__auto___250678 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___250678 == null)){
} else {
var key_250679 = temp__5808__auto___250678;
(jsprops.key = key_250679);
}
...
var temp__5808__auto___250682 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___250682 == null)){
} else {
var key_250684 = temp__5808__auto___250682;
(jsprops.key = key_250684);
}
...
var temp__5808__auto___250695 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___250695 == null)){
} else {
var key_250696 = temp__5808__auto___250695;
(jsprops.key = key_250696);
}
...
var temp__5808__auto___250701 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___250701 == null)){
} else {
var key_250702 = temp__5808__auto___250701;
(jsprops.key = key_250702);
}
...
var temp__5808__auto___250704 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___250704 == null)){
} else {
var key_250705 = temp__5808__auto___250704;
(jsprops.key = key_250705);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__250618_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__250618_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__250619 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__250619,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__250619,(1),null);
...
break;
default:
var G__250715 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__250716 = compiler;
v = G__250715;
compiler = G__250716;
continue;
...
var G__250630 = tag;
var G__250630__$1 = (((G__250630 instanceof cljs.core.Keyword))?G__250630.fqn:null);
switch (G__250630__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template250642 = (function (opts,id,fn_to_element,parse_fn,meta250643){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta250643 = meta250643;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template250642.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_250644,meta250643__$1){
var self__ = this;
var _250644__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template250642(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta250643__$1));
}));

(reagent.impl.template.t_reagent$impl$template250642.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_250644){
var self__ = this;
var _250644__$1 = this;
return self__.meta250643;
}));

(reagent.impl.template.t_reagent$impl$template250642.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template250642.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template250642.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template250642.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template250642.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template250642.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta250643","meta250643",-397522343,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template250642.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template250642.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template250642");

(reagent.impl.template.t_reagent$impl$template250642.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template250642");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template250642.
 */
reagent.impl.template.__GT_t_reagent$impl$template250642 = (function reagent$impl$template$__GT_t_reagent$impl$template250642(opts,id,fn_to_element,parse_fn,meta250643){
return (new reagent.impl.template.t_reagent$impl$template250642(opts,id,fn_to_element,parse_fn,meta250643));
});
...
return (new reagent.impl.template.t_reagent$impl$template250642(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
