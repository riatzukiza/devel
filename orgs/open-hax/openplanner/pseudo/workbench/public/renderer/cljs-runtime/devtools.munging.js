...
var o241767 = temp__5802__auto__;
var temp__5802__auto____$1 = (o241767["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o241768 = temp__5802__auto____$1;
return (o241768["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20542__auto__ = f;
return (o__20542__auto__["toString"]).call(o__20542__auto__);
} else {
return "";
}
}catch (e241788){var _ = e241788;
return "";
}});
...
try{var o__20542__auto___242752 = t;
(o__20542__auto___242752["cljs$lang$ctorPrWriter"]).call(o__20542__auto___242752,t,writer);
}catch (e241827){var __242753 = e241827;
}
...
var char_code = (function (){var o__20542__auto__ = (new String(char$));
return (o__20542__auto__["charCodeAt"]).call(o__20542__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20542__auto__ = String;
return (o__20542__auto__["fromCharCode"]).call(o__20542__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__241859 = num_code;
switch (G__241859) {
case (1):
return (185);
...
var o__20542__auto__ = String;
return (o__20542__auto__["fromCharCode"]).call(o__20542__auto__,superscript_code);
});
/**
...
}catch (e241904){var _e__20586__auto__ = e241904;
return false;
}})())){
...
var vec__241920 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__241920,(0),null);
...
var len__5726__auto___242777 = arguments.length;
var i__5727__auto___242778 = (0);
while(true){
if((i__5727__auto___242778 < len__5726__auto___242777)){
args__5732__auto__.push((arguments[i__5727__auto___242778]));

var G__242780 = (i__5727__auto___242778 + (1));
i__5727__auto___242778 = G__242780;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__242003){
var vec__242005 = p__242003;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242005,(0),null);
...
var G__242788 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__242789 = cljs.core.butlast(remaining_tokens);
name_tokens = G__242788;
remaining_tokens = G__242789;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq241993){
var G__241994 = cljs.core.first(seq241993);
var seq241993__$1 = cljs.core.next(seq241993);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__241994,seq241993__$1);
}));
...
var vec__242044 = cljs.core.split_with((function (p1__242040_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__242040_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242044,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242044,(1),null);
...
var vec__242086 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242086,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242086,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__242806 = cljs.core.rest(remaining_tokens);
var G__242807 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__242806;
name_tokens = G__242807;
continue;
} else {
...
var G__242116 = arguments.length;
switch (G__242116) {
case 1:
...
var vec__242134 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242134,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242134,(1),null);
var vec__242137 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242137,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242137,(1),null);
var vec__242140 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242140,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242140,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242140,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242140,(3),null);
...
var G__242162 = arguments.length;
switch (G__242162) {
case 1:
...
var vec__242169 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242169,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242169,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242169,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242169,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242169,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242169,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__242182 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242182,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242182,(1),null);
var vec__242186 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242186,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242186,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__242203 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__242203) : devtools.munging.parse_fn_info_deep.call(null,G__242203));
})()));
}
} else {
return fn_info;
...
var G__242863 = (arity + (1));
var G__242864 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__242267){
var vec__242269 = p__242267;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242269,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242269,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__242335_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__242335_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__242336_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__242336_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___242878 = arguments.length;
var i__5727__auto___242879 = (0);
while(true){
if((i__5727__auto___242879 < len__5726__auto___242878)){
args__5732__auto__.push((arguments[i__5727__auto___242879]));

var G__242880 = (i__5727__auto___242879 + (1));
i__5727__auto___242879 = G__242880;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__242385){
var vec__242386 = p__242385;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242386,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq242364){
var G__242366 = cljs.core.first(seq242364);
var seq242364__$1 = cljs.core.next(seq242364);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__242366,seq242364__$1);
}));
...
var G__242408 = arg;
var G__242408__$1 = (((G__242408 instanceof cljs.core.Keyword))?G__242408.fqn:null);
switch (G__242408__$1) {
...
var map__242485 = options;
var map__242485__$1 = cljs.core.__destructure_map(map__242485);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__242485__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__242485__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__242485__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__242485__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__242486 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242486,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242486,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242486,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242486,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242486,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242486,(5),null);
...
var o__20542__auto__ = f;
return (o__20542__auto__["getBasis"]).call(o__20542__auto__);
});
/**
...
}catch (e242527){var _e__20586__auto__ = e242527;
...
var G__242909 = (obj[cljs.core.first(path)]);
var G__242910 = cljs.core.rest(path);
obj = G__242909;
path = G__242910;
continue;
} else {
...
var _STAR_ = (function (accum,p__242624){
var vec__242626 = p__242624;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242626,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242626,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__242664){
var vec__242670 = p__242664;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242670,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242670,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242670,(2),null);
...
var post_process = (function (p__242704){
var vec__242706 = p__242704;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242706,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242706,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__242697_SHARP_){
return (obj[cljs.core.first(p1__242697_SHARP_)]);
}),sorted_matches);
