...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_250591 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_250591(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_250596 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_250596(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_250598 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_250598(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_250601 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_250601(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_250608 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_250608(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_250609 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_250609(reader);
}
});
...
var G__250553 = arguments.length;
switch (G__250553) {
case 1:
...
var G__250557 = arguments.length;
switch (G__250557) {
case 1:
...
var G__250562 = arguments.length;
switch (G__250562) {
case 1:
...
var G__250651 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__250652 = s.append(c);
c = G__250651;
s = G__250652;
continue;
}
