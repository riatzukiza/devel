...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_243319 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_243319(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_243327 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_243327(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_243328 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_243328(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_243335 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_243335(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_243347 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_243347(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_243352 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_243352(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__243300,callback){
var map__243304 = p__243300;
var map__243304__$1 = cljs.core.__destructure_map(map__243304);
var input = map__243304__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__243304__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__243304__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
