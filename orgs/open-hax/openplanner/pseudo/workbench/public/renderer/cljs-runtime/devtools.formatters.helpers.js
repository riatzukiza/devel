...
var G__242887 = devtools.prefs.pref(v);
v = G__242887;
continue;
} else {
return v;
...
}catch (e242779){var _e__20586__auto__ = e242779;
return false;
}})();
...
}catch (e242783){var _e__20586__auto__ = e242783;
return false;
}})();
...
}catch (e242790){var _e__20586__auto__ = e242790;
return false;
}}
}
});
...
var vec__242824 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242824,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__242824,(1),null);
...
return cljs.core.some((function (p1__242840_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__242840_SHARP_);
}),template);
});
