...
export const apps = [
  ...
  },
  {
    ...
    env: {
      NODE_ENV: 'production',
      KG_RELATED_TOPN: process.env.KG_RELATED_TOPN ?? '5',
      KG_RELATED_TTL_MS: process.env.KG_RELATED_TTL_MS ?? String(7 * 24 * 60 * 60 * 1000),
      KG_RELATED_CACHE: process.env.KG_RELATED_CACHE ?? './.cache/knowledge-graph/embeddings',
    },
    instances: 1,
    interpreter: '/usr/bin/env',
    autorestart: true,
