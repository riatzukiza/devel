---
uuid: 0aa76a24-2f54-4f4b-94a4-d204d2855e4a
created_at: '2025-09-19T21:08:02Z'
title: 2025.09.19.21.08.02
filename: process.md
description: >-
  A minimal, surgical update to the process document that integrates cloud-agent
  phases over timeboxes, artifact-every-session, and auto-split rules without
  altering the board structure. Ensures session discipline and phased execution
  for clean, maintainable workflows.
tags:
  - cloud-agent
  - phased-execution
