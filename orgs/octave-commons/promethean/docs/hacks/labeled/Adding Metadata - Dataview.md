...
A metadata field is a pair of a **key** and a **value**. The _value_ of a field has a data type (more on that [here](https://blacksmithgu.github.io/obsidian-dataview/annotation/types-of-metadata/)) that determines how this field will behave when querying it.
