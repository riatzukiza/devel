---
uuid: f81f938a-5f59-425c-8b1c-c726a1c273ee
created_at: '2025-10-07T22:43:20Z'
title: 2025.10.07.22.43.20
filename: Local Model Benchmarking for 8GB VRAM Systems
description: >-
  A practical guide to testing tool-calling text models (Gemma 3 variants),
  vision models (MiniCPM-V 4.5), and reasoning capabilities on 8GB VRAM systems
  using CPU offload. Includes benchmarks with Aider Polyglot and BFCL for coding
  and tool usage, alongside remote judge comparisons via OpenRouter and Z.ai.
tags:
  - model benchmarking
  - local inference
  - 8gb vram
