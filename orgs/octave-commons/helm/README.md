...
Continuously discover repos under ~/devel, spawn opencode servers per repo, index sessions for RAG, and provide a Shadow CLJS UI hub.
...
```bash
pnpm -w add -D @promethean-os/opencode-hub
```
