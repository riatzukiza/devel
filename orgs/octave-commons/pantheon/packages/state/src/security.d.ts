...
export declare const validatePermissions: (input: ValidatePermissionsInput, scope: ValidatePermissionsScope) => string[];
...
export declare const sanitizeObject: (input: SanitizeObjectInput, scope: SanitizeObjectScope) => unknown;
export declare const SecurityValidator: {
    ...
    validatePermissions: (permissions: unknown) => string[];
...
export declare class RateLimiter {
    ...
    private attempts;
    constructor(windowMs?: number, // 1 minute
    maxAttempts?: number);
