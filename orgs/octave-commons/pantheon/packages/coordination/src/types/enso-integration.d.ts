...
export type RoomType = 'task_coordination' | 'team_collaboration' | 'capability_sharing' | 'knowledge_exchange' | 'resource_pooling' | 'emergency_response' | 'learning_community';
...
export type CommunicationType = 'status_update' | 'question' | 'decision' | 'request' | 'notification' | 'alert' | 'knowledge_sharing';
...
export type LessonCategory = 'technical' | 'process' | 'communication' | 'coordination' | 'tools' | 'methodology';
...
export type ArtifactType = 'code' | 'documentation' | 'design' | 'test' | 'configuration' | 'data' | 'model' | 'report';
...
export type ContextType = 'task_context' | 'project_context' | 'team_context' | 'knowledge_base' | 'best_practices' | 'templates' | 'standards';
...
export type ConditionType = 'skill_level' | 'security_clearance' | 'team_membership' | 'project_role' | 'custom';
...
export type ResponseType = 'accepted' | 'rejected' | 'conditional' | 'deferred' | 'alternative_offered';
...
export type ToolType = 'cli' | 'api' | 'library' | 'service' | 'interface' | 'workflow' | 'automation' | 'analysis';
...
export type MessageType = 'task_assignment' | 'task_update' | 'capability_request' | 'capability_offer' | 'tool_request' | 'tool_offer' | 'coordination_request' | 'status_update' | 'knowledge_sharing' | 'decision_notification' | 'resource_request' | 'emergency_alert';
...
export type BroadcastType = 'system_announcement' | 'capability_sharing' | 'tool_availability' | 'emergency_alert' | 'knowledge_update' | 'policy_change' | 'maintenance_notice';
...
//# sourceMappingURL=enso-integration.d.ts.map