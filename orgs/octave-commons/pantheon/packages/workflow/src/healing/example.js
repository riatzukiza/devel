 ...
 */
import { DefaultWorkflowHealingIntegration } from './integration.js';
 ...
 */
export async function runHealingExample() {
    ...
    try {
        ...
        if (updatedHealth.activeIssues.length > 0) {
            ...
            console.log('Healing Results:', healingResults.map((result) => ({
        ...
        console.log('All Workflows Health:', Object.keys(allHealth).map((workflowId) => {
 ...
 */
export async function manualHealingExample() {
