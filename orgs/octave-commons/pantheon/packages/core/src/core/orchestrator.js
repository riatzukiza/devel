 ...
 */
export const makeOrchestrator = (deps) => {
            ...
            case 'context':
                ...
                switch (action.operation) {
                    ...
                    case 'delete':
                        ...
                        break;
                    default:
                        throw new Error(`Unknown context operation: ${action.operation}`);
                }
                break;
            default:
    ...
    const selectBehaviors = (actor, hasUserInput) => {
    ...
    const tickActor = async (actor, input) => {
    ...
    const startActorLoop = (actor, intervalMs = 5000) => {
        let isActive = true;
    ...
    const cleanupActor = async (actorId) => {
    ...
    const pauseActor = async (actorId) => {
    ...
    const resumeActor = async (actorId) => {
    ...
    return {
        tickActor,
        startActorLoop,
        executeAction: (action, actor) => executeAction(action, actor),
        cleanupActor,
        pauseActor,
        resumeActor,
    };
