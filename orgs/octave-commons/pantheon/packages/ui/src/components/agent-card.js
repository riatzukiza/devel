...
let AgentCard = class AgentCard extends LitElement {
    static styles = css `
    :host {
      display: block;
      background: white;
    ...
    render() {
      ...
      <div class="card-footer">
        ...
        <div class="actions">
          <button
            class="action-button"
            @click=${(e) => this.handleActionClick('restart', e)}
            title="Restart Agent"
          >
            🔄
          </button>
          <button
            class="action-button"
            @click=${(e) => this.handleActionClick('configure', e)}
          ...
          <button
            class="action-button"
            @click=${(e) => this.handleActionClick('logs', e)}
            title="View Logs"
          >
            📄
          </button>
...
], AgentCard.prototype, "agent", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], AgentCard.prototype, "selected", void 0);
__decorate([
    property({ type: Boolean })
], AgentCard.prototype, "compact", void 0);
AgentCard = __decorate([
