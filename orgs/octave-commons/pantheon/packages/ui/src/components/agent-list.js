...
let AgentList = class AgentList extends LitElement {
    static styles = css `
    :host {
      display: block;
      background: white;
  ...
  `;
    ...
    handleActionClick(agent, action, event) {
      ...
      ${this.agents.map((agent) => {
          ...
          >
            ...
            <div class="actions">
              <button
                class="action-button"
                @click=${(e) => this.handleActionClick(agent, 'restart', e)}
                title="Restart Agent"
              >
                🔄
              </button>
              <button
                class="action-button"
                @click=${(e) => this.handleActionClick(agent, 'configure', e)}
              ...
              <button
                class="action-button"
                @click=${(e) => this.handleActionClick(agent, 'logs', e)}
                title="View Logs"
              >
                📄
              </button>
...
], AgentList.prototype, "selectedAgentId", void 0);
__decorate([
    property({ type: Boolean })
], AgentList.prototype, "compact", void 0);
AgentList = __decorate([
