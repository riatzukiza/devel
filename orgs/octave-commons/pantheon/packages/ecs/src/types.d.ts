...
export type TurnComponent = Readonly<{
    id: number;
}>;
export type RawVadComponent = Readonly<{
    level: number;
    ts: number;
}>;
...
export type PlaybackQueueComponent = Readonly<{
...
export type AudioRefComponent = Readonly<{
    player: AudioPlayer;
}>;
...
export type AudioResComponent = Readonly<{
    factory: AudioResourceFactory;
}>;
export type TranscriptFinalComponent = Readonly<{
    text: string;
    ts: number;
}>;
export type VisionFrameRef = Readonly<{
    type: 'url';
    url: string;
}> | Readonly<{
    type: 'blob';
...
export type PolicyComponent = Readonly<{
    defaultBargeIn: BargeIn;
}>;
export type VoiceConnection = {
    readonly subscribe?: (player: unknown) => void;
    readonly destroy?: () => void;
};
export type VoiceStateComponent = Readonly<{
