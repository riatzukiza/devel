...
This document specifies the GitHub Actions workflows configured for the Gates of Aker project, providing automated testing, linting, and build verification for both frontend and backend components.
