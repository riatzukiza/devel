...
const index_js_1 = require("./orgs/riatzukiza/promethean/packages/pantheon/llm-openai/dist/index.js");
    ...
    try {
        ...
        if (modelsRes.ok) {
            ...
            const modelIds = Array.isArray(models?.data)
                ? models.data.map((m) => m.id).slice(0, 5)
                : models;
        ...
        // Test LLM adapter
        const llm = (0, index_js_1.makeOpenAIAdapter)({
            apiKey,
            baseURL,
