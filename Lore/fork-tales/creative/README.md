...
## Files
- `Lore/fork-tales/creative/the-weight-of-the-glitch.ustx` — OpenUtau `.ustx` project
- `Lore/fork-tales/creative/README.md` — this workflow note
...
## Render workflow
1. Open `Lore/fork-tales/creative/the-weight-of-the-glitch.ustx` in OpenUtau.
