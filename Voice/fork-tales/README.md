...
## Files
- `Voice/fork-tales/shatter-symphony-vocals.ustx` — OpenUtau `.ustx` project
- `Voice/fork-tales/README.md` — this workflow note
...
## Render workflow
1. Open `Voice/fork-tales/shatter-symphony-vocals.ustx` in OpenUtau.
