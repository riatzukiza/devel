# Timing Shit (The LSTM Ghost)

Generated by Knoxx as an OpenUtau singing-project scaffold.

## Files
- `Voice/fork_tales/timing_shit_vocals.ustx` — OpenUtau `.ustx` project
- `Voice/fork_tales/README.md` — this workflow note
...
## Render workflow
1. Open `Voice/fork_tales/timing_shit_vocals.ustx` in OpenUtau.
